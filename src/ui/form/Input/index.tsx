...
const Input = ({ className, label, labelClass = "", ...rest }: IInput) => {
  ...
  return (
    <div className={cn(`min-w-72 ${className}`)}>
      ...
      <input
        ...
        className={cn(
          `rounded-lg bg-brand_gray-100 transition-all duration-200 dark:bg-brand_gray-500 text-sm  w-full outline-none px-4 h-12   `,
          {
