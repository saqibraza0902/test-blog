...
const Home = () => {
  return (
    <CommonLayout>
      <section className="bg-white dark:bg-black pl-10 pr-5 py-20 lg:mt-0 lg:px-28 h-full lg:h-full flex  flex-col justify-center items-center">
        <HomeSection />
      </section>
      <section className="h-max bg-brand_green-300 p-3  lg:p-20">
        <Services />
      </section>

      <section className="h-full bg-brand_blue-300 flex flex-col lg:flex-row w-full pr-6 pl-3 lg:px-20 py-10">
        <RatingSection />
      </section>
      <section className="min-h-screen h-full lg:p-20 bg-brand_blue-100">
        <WorkSection />
      </section>
