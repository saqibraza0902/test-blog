...
const Home = async () => {
  ...
  return (
    <CommonLayout>
      <section className="bg-white dark:bg-black py-20 lg:mt-0 lg:px-28 h-full lg:h-full 2xl:h-screen flex  flex-col justify-center items-center">
      ...
      <section className="h-full 2xl:h-screen bg-brand_green-300 pl-4 pr-9 py-20 lg:p-20">
      ...
      <section className="min-h-screen pl-4 pr-9 2xl:h-screen flex items-center justify-center h-full lg:p-20 bg-brand_blue-100">
