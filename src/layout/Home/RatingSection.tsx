...
const RatingSection = ({ rating }: IProp) => {
  ...
  return (
    <>
      <div className="w-full lg:w-3/12  flex flex-row justify-between items-center lg:items-start lg:px-0 lg:justify-end lg:flex-col 2xl:justify-center  text-white">
